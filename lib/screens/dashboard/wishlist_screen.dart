    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Expanded(
              child: BlocProvider(
                  create: (context) => DiscoverCubit()..fetchAllWishlistProducts(context: context),
                        ...
                        : state is DiscoverEmptyState
                            ? Center(
                                child: SemiBoldTextView(
                                    data: "Wishlist is empty!", fontSize: 18, textColor: AppColors.redColor))
                                  ...
                                  return SingleChildScrollView(
                                      ...
                                      child: SizedBox(
                                          ...
                                          child: Wrap(
                                              ...
                                              runSpacing: 10,
                                              children: List.generate(cubit.wishList.length, (int index) {
                                                return ProductCardView(productModel: cubit.wishList[index]);
                                              }))));
                                },
                              );
                  })))
